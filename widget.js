...
var MATCH_DATA = [
  ...
  { num: 19, phase: 'group', group: 'D', t1: 'USA', t2: 'PAR', date: '2026-06-12', time: '18:00', stadium: 'SoFi Stadium',          city: 'Los Angeles'  },
  { num: 20, phase: 'group', group: 'D', t1: 'AUS', t2: 'TUR', date: '2026-06-13', time: '21:00', stadium: 'BC Place',              city: 'Vancouver'    },
  { num: 21, phase: 'group', group: 'D', t1: 'USA', t2: 'AUS', date: '2026-06-19', time: '12:00', stadium: 'Lumen Field',           city: 'Seattle'      },
  { num: 22, phase: 'group', group: 'D', t1: 'TUR', t2: 'PAR', date: '2026-06-19', time: '20:00', stadium: "Levi's Stadium",        city: 'San Francisco'},
  { num: 23, phase: 'group', group: 'D', t1: 'TUR', t2: 'USA', date: '2026-06-25', time: '19:00', stadium: 'SoFi Stadium',          city: 'Los Angeles'  },
  { num: 24, phase: 'group', group: 'D', t1: 'PAR', t2: 'AUS', date: '2026-06-25', time: '19:00', stadium: "Levi's Stadium",        city: 'San Francisco'},
  // ── Groupe E (GER, CUW, CIV, ECU) ──────────────────────────────────
  { num: 25, phase: 'group', group: 'E', t1: 'GER', t2: 'CUW', date: '2026-06-14', time: '12:00', stadium: 'NRG Stadium',           city: 'Houston'      },
  ...
  { num: 28, phase: 'group', group: 'E', t1: 'ECU', t2: 'CUW', date: '2026-06-20', time: '19:00', stadium: 'Arrowhead Stadium',     city: 'Kansas City'  },
  ...
  { num: 31, phase: 'group', group: 'F', t1: 'NED', t2: 'JPN', date: '2026-06-14', time: '15:00', stadium: "AT&T Stadium",          city: 'Dallas'       },
  { num: 32, phase: 'group', group: 'F', t1: 'SWE', t2: 'TUN', date: '2026-06-14', time: '20:00', stadium: 'Estadio BBVA',          city: 'Monterrey'    },
  { num: 33, phase: 'group', group: 'F', t1: 'NED', t2: 'SWE', date: '2026-06-20', time: '12:00', stadium: 'NRG Stadium',           city: 'Houston'      },
  { num: 34, phase: 'group', group: 'F', t1: 'TUN', t2: 'JPN', date: '2026-06-20', time: '22:00', stadium: 'Estadio BBVA',          city: 'Monterrey'    },
  { num: 35, phase: 'group', group: 'F', t1: 'JPN', t2: 'SWE', date: '2026-06-25', time: '18:00', stadium: "AT&T Stadium",          city: 'Dallas'       },
  { num: 36, phase: 'group', group: 'F', t1: 'TUN', t2: 'NED', date: '2026-06-25', time: '18:00', stadium: 'Arrowhead Stadium',     city: 'Kansas City'  },
  // ── Groupe G (BEL, EGY, IRN, NZL) ──────────────────────────────────
  { num: 37, phase: 'group', group: 'G', t1: 'BEL', t2: 'EGY', date: '2026-06-15', time: '12:00', stadium: 'Lumen Field',           city: 'Seattle'      },
  { num: 38, phase: 'group', group: 'G', t1: 'IRN', t2: 'NZL', date: '2026-06-15', time: '18:00', stadium: 'SoFi Stadium',          city: 'Los Angeles'  },
  { num: 39, phase: 'group', group: 'G', t1: 'BEL', t2: 'IRN', date: '2026-06-21', time: '12:00', stadium: 'SoFi Stadium',          city: 'Los Angeles'  },
  { num: 40, phase: 'group', group: 'G', t1: 'NZL', t2: 'EGY', date: '2026-06-21', time: '18:00', stadium: 'BC Place',              city: 'Vancouver'    },
  { num: 41, phase: 'group', group: 'G', t1: 'EGY', t2: 'IRN', date: '2026-06-26', time: '20:00', stadium: 'Lumen Field',           city: 'Seattle'      },
  { num: 42, phase: 'group', group: 'G', t1: 'NZL', t2: 'BEL', date: '2026-06-26', time: '20:00', stadium: 'BC Place',              city: 'Vancouver'    },
  ...
  { num: 47, phase: 'group', group: 'H', t1: 'CPV', t2: 'KSA', date: '2026-06-26', time: '19:00', stadium: 'NRG Stadium',           city: 'Houston'      },
  { num: 48, phase: 'group', group: 'H', t1: 'URU', t2: 'ESP', date: '2026-06-26', time: '18:00', stadium: 'Estadio Akron',         city: 'Guadalajara'  },
  ...
  { num: 55, phase: 'group', group: 'J', t1: 'ARG', t2: 'ALG', date: '2026-06-16', time: '20:00', stadium: 'Arrowhead Stadium',     city: 'Kansas City'  },
  { num: 56, phase: 'group', group: 'J', t1: 'AUT', t2: 'JOR', date: '2026-06-16', time: '21:00', stadium: "Levi's Stadium",        city: 'San Francisco'},
  { num: 57, phase: 'group', group: 'J', t1: 'ARG', t2: 'AUT', date: '2026-06-22', time: '12:00', stadium: "AT&T Stadium",          city: 'Dallas'       },
  { num: 58, phase: 'group', group: 'J', t1: 'JOR', t2: 'ALG', date: '2026-06-22', time: '20:00', stadium: "Levi's Stadium",        city: 'San Francisco'},
  { num: 59, phase: 'group', group: 'J', t1: 'JOR', t2: 'ARG', date: '2026-06-27', time: '21:00', stadium: "AT&T Stadium",          city: 'Dallas'       },
  { num: 60, phase: 'group', group: 'J', t1: 'ALG', t2: 'AUT', date: '2026-06-27', time: '21:00', stadium: 'Arrowhead Stadium',     city: 'Kansas City'  },
  // ── Groupe K (POR, COD, UZB, COL) ──────────────────────────────────
  { num: 61, phase: 'group', group: 'K', t1: 'POR', t2: 'COD', date: '2026-06-17', time: '12:00', stadium: 'NRG Stadium',           city: 'Houston'      },
  { num: 62, phase: 'group', group: 'K', t1: 'UZB', t2: 'COL', date: '2026-06-17', time: '20:00', stadium: 'Estadio Azteca',        city: 'Mexico City'  },
  { num: 63, phase: 'group', group: 'K', t1: 'POR', t2: 'UZB', date: '2026-06-23', time: '12:00', stadium: 'NRG Stadium',           city: 'Houston'      },
  { num: 64, phase: 'group', group: 'K', t1: 'COL', t2: 'COD', date: '2026-06-23', time: '20:00', stadium: 'Estadio Akron',         city: 'Guadalajara'  },
  ...
  { num: 67, phase: 'group', group: 'L', t1: 'ENG', t2: 'CRO', date: '2026-06-17', time: '15:00', stadium: "AT&T Stadium",          city: 'Dallas'       },
  ...
  { num: 73,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-06-28', time: '12:00', stadium: 'SoFi Stadium',          city: 'Los Angeles'  },
  { num: 74,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-06-29', time: '16:30', stadium: 'Gillette Stadium',      city: 'Boston'       },
  { num: 75,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-06-29', time: '19:00', stadium: 'Estadio BBVA',          city: 'Monterrey'    },
  { num: 76,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-06-29', time: '12:00', stadium: 'NRG Stadium',           city: 'Houston'      },
  { num: 77,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-06-30', time: '17:00', stadium: 'MetLife Stadium',       city: 'New York'     },
  { num: 78,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-06-30', time: '12:00', stadium: "AT&T Stadium",          city: 'Dallas'       },
  { num: 79,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-06-30', time: '19:00', stadium: 'Estadio Azteca',        city: 'Mexico City'  },
  { num: 80,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-01', time: '12:00', stadium: 'Mercedes-Benz Stadium', city: 'Atlanta'      },
  { num: 81,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-01', time: '17:00', stadium: "Levi's Stadium",        city: 'San Francisco'},
  { num: 82,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-01', time: '13:00', stadium: 'Lumen Field',           city: 'Seattle'      },
  { num: 83,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-02', time: '19:00', stadium: 'BMO Field',             city: 'Toronto'      },
  { num: 84,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-02', time: '12:00', stadium: 'SoFi Stadium',          city: 'Los Angeles'  },
  { num: 85,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-02', time: '20:00', stadium: 'BC Place',              city: 'Vancouver'    },
  ...
  { num: 88,  phase: 'r32', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-03', time: '13:00', stadium: "AT&T Stadium",          city: 'Dallas'       },
  ...
  { num: 90,  phase: 'r16', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-04', time: '12:00', stadium: 'NRG Stadium',           city: 'Houston'      },
  { num: 91,  phase: 'r16', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-05', time: '16:00', stadium: 'MetLife Stadium',       city: 'New York'     },
  { num: 92,  phase: 'r16', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-05', time: '18:00', stadium: 'Estadio Azteca',        city: 'Mexico City'  },
  { num: 93,  phase: 'r16', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-06', time: '14:00', stadium: "AT&T Stadium",          city: 'Dallas'       },
  { num: 94,  phase: 'r16', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-06', time: '17:00', stadium: 'Lumen Field',           city: 'Seattle'      },
  { num: 95,  phase: 'r16', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-07', time: '12:00', stadium: 'Mercedes-Benz Stadium', city: 'Atlanta'      },
  { num: 96,  phase: 'r16', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-07', time: '13:00', stadium: 'BC Place',              city: 'Vancouver'    },
  ...
  { num: 98,  phase: 'qf', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-10', time: '12:00', stadium: 'SoFi Stadium',          city: 'Los Angeles'  },
  { num: 99,  phase: 'qf', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-11', time: '17:00', stadium: 'Hard Rock Stadium',     city: 'Miami'        },
  { num: 100, phase: 'qf', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-11', time: '20:00', stadium: 'Arrowhead Stadium',     city: 'Kansas City'  },
  // ── Demi-finales (2 matchs) ────────────────────────────────────────
  { num: 101, phase: 'sf', group: '', t1: 'TBD', t2: 'TBD', date: '2026-07-14', time: '14:00', stadium: "AT&T Stadium",          city: 'Dallas'       },
...
// Table officielle FIFA 2026 (Annexe C, 495 combinaisons) : à quelle position de
// groupe appartient le 3e affecté à chaque match « 1er vs 3e ».
// Clé = 8 lettres des groupes dont le 3e est qualifié (triées) ;
// valeur = 8 lettres (groupe du 3e) dans l'ordre des colonnes 1A,1B,1D,1E,1G,1I,1K,1L.
// Source : Template:2026 FIFA World Cup third-place table (Wikipédia / règlement FIFA).
var THIRD_WIN_ORDER = ['A','B','D','E','G','I','K','L'];
var THIRD_WIN_MATCH = { A: 79, B: 85, D: 81, E: 74, G: 82, I: 77, K: 87, L: 80 };
...
function computeBracket() {
  ...
  // 2) Meilleurs 3es (uniquement quand tous les groupes sont terminés) via table officielle FIFA
  if (allGroupsDone) {
    var thirds = groups
      .map(function(g) { return standingsByGroup[g][2]; })
      .filter(Boolean)
      .sort(function(a, b) { return b.pts - a.pts || b.diff - a.diff || b.gf - a.gf; });
    var qualGroups = thirds.slice(0, 8).map(function(s) { return s.group; }).sort();
    var assignment = THIRD_PLACE_TABLE[qualGroups.join('')];
    if (assignment) {
      for (var wi = 0; wi < THIRD_WIN_ORDER.length; wi++) {
        var winG = THIRD_WIN_ORDER[wi];      // groupe du 1er (côté a)
        var thirdG = assignment.charAt(wi);  // groupe du 3e affecté (côté b)
        var mt = matchByNum(THIRD_WIN_MATCH[winG]);
        if (mt && standingsByGroup[thirdG] && standingsByGroup[thirdG][2]) {
          mt.t2 = standingsByGroup[thirdG][2].code;
        }
      }
    }
  }
